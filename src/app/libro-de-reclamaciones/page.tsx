            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="mt-6 text-lg sm:text-xl text-white/70 max-w-xl leading-relaxed">
                  Ejerce tu derecho como consumidor. En CRÉDITOS YADIEL
              ...
              >
                <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-black/30">
                  <Image
                    src="/images/side-reclamaciones.webp"
                    alt="Libro de Reclamaciones - CRÉDITOS YADIEL"
                    width={560}
                    height={380}
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl border px-4 py-3 text-sm text-white focus:border-[#C9A961] focus:ring-2 focus:ring-[#C9A961]/20 outline-none transition-all duration-200 placeholder:text-slate-500 ${
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-sm text-white focus:border-[#C9A961] focus:ring-2 focus:ring-[#C9A961]/20 outline-none transition-all duration-200 placeholder:text-slate-500"
                  />
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    className={`w-full rounded-xl border px-4 py-3 text-sm text-white focus:border-[#C9A961] focus:ring-2 focus:ring-[#C9A961]/20 outline-none transition-all duration-200 placeholder:text-slate-500 resize-none ${
                      errors.descripcion
                        ? "border-red-400/60 bg-red-500/10"
                        : "border-white/10 bg-white/[0.06]"
                    }`}
