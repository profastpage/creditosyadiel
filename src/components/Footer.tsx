      ...
      <div className="bg-[#1B3A57]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#C9A961] text-white px-5 py-2 rounded-xl text-sm font-bold hover:bg-[#D4BC7A] transition-colors duration-200"
          >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <Phone className="w-4 h-4 text-[#C9A961] mt-0.5 shrink-0" />
                <div>
              ...
              <li className="flex items-start gap-3">
                <Mail className="w-4 h-4 text-[#C9A961] mt-0.5 shrink-0" />
                <div>
                  <p className="text-sm text-slate-300 font-medium">
                    Correo Electrónico
                  </p>
                  <a href="mailto:contacto@creditosyadiel.com" className="text-sm text-slate-400 hover:text-[#C9A961] transition-colors duration-200">
                    {SITE_CONFIG.email}
                  </a>
                </div>
              </li>
