  ...
  return (
    <section className="relative py-16 sm:py-24" id="calculadora">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/[0.06] text-[#C9A961] px-4 py-2 rounded-full text-sm font-medium mb-4">
          ...
          <div className="lg:col-span-3 bg-white/[0.02] backdrop-blur-md border border-white/5 rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 transition-all duration-300">
            ...
            <div className="mb-8">
              <div className="flex items-baseline justify-between mb-3">
                ...
                <motion.span
                  ...
                  className="text-2xl sm:text-3xl font-extrabold text-[#C9A961]"
                >
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              <div className="bg-white/[0.04] rounded-2xl p-4 text-center">
                <p className="text-xs sm:text-sm text-[#C9A961] font-medium mb-1">
                  Cuota Mensual
                </p>
                <motion.p
                  ...
                  initial={{ scale: 1.05 }}
                  animate={{ scale: 1 }}
                  className="text-lg sm:text-2xl font-extrabold text-[#C9A961]"
                >
